...
puts "Je destroy toutes les données"
...
u11.photo = Rails.root.join("app/assets/images/durand.jpg").open
u11.save

puts "Creating Spots"

goulag = Spot.create!(description: "Brand new goulag", guest_number: 10_000, price: 5, good: false, image: "urss.jpg", user_id: u5.id, occupation: "dictator")
goulag.photo = Rails.root.join("app/assets/images/urss.jpg").open
goulag.save
